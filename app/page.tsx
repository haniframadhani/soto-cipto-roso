      ...
      <div className="w-full max-x-6xl px-4">
        <section className="py-16 md:py-24" id="hero">
          <div className="@container">
            <div className="flex min-h-120 flex-col items-center justify-center gap-6 rounded-xl bg-cover bg-center bg-no-repeat p-8 text-center bg-[linear-gradient(rgba(23,18,18,0.4)_0%,rgba(23,18,18,0.7)_100%),url(/hero.jpg)]">
              <div className="flex flex-col gap-4 items-center text-center">
                <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] text-primary-foreground md:text-6xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link href="#contact">
                    ...
                    <span className="truncate">Download Proposal</span>
                  </Link>
                </Button>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24" id="about">
          ...
          <div className="">
            <div className="flex flex-col gap-4 text-center">
              ...
              <p className="text-lg font-normal leading-relaxed text-foreground/80">
                Soto Cipto Roso adalah kedai soto khas Semarang yang mempunyai
                cita rasa yang lezat higienis dan mempunyai tempat yang nyaman.
                Kedai soto ini berdiri sejak tahun 2017 dengan lokasi di
                Kadisoka, Sleman, Yogyakarta yang mempunyai omzet harian saat
                ini mencapai 4 juta rupiah/hari.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24" id="menu">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
            <Card className="overflow-hidden pt-0">
              ...
              <CardContent>
                <CardTitle className="text-2xl">Soto</CardTitle>
            ...
            <Card className="overflow-hidden pt-0">
              ...
              <CardContent>
                <CardTitle className="text-2xl">Aneka Gorengan</CardTitle>
                <CardDescription className="mt-2 text-lg">
            ...
            <Card className="overflow-hidden pt-0">
              ...
              <CardContent>
                <CardTitle className="text-2xl">Aneka sate</CardTitle>
                <CardDescription className="mt-2 text-lg">
                  Ada banyak sekali varian sate di kedai Soto Cipto Roso seperti
                  sate telur puyuh, sate usus, sate kerang, sate paru, sate
                  uritan & ampela, sate brutu dan sate bakso.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="py-16 md:py-24" id="gallery">
          <div className="flex flex-col items-center gap-4 text-center">
            <h2 className="text-4xl font-bold leading-tight tracking-[-0.015em] text-text-light  md:text-5xl">
              Lebih Dari Sekadar Foto: Bukti Visual Kesuksesan
            </h2>
            <p className="max-w-2xl text-lg font-normal leading-relaxed text-text-light/80">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
            <Card>
              <CardContent className="flex flex-col items-center text-center">
                ...
                <CardDescription className="text-lg text-text-light/80 mt-2">
        ...
        <section className="py-16 md:py-24" id="projection">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-3xl text-lg font-normal leading-relaxed text-text-light/80">
              ...
              <CardContent>
                ...
                <div className="my-6 flex-1 space-y-4 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-text-light">30 Hari</p>
                  </div>
                  <div>
          ...
          <p className="mt-8 text-center text-sm text-text-light/70">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            <Card className="rounded-xl bg-white p-8 shadow-md dark:bg-card-dark">
              <CardContent>
                ...
                <ul className="mt-4 space-y-3 text-text-light/80 text-lg">
            ...
            <Card className="rounded-xl bg-white p-8 shadow-md dark:bg-card-dark">
              <CardContent>
                ...
                <ol className="mt-4 space-y-3 text-text-light/80 text-lg">
                  <li className="flex items-start gap-3">
